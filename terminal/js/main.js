...
console.log("run \"game\" if your not a pussy")
...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("visitor@shantry.com:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    case "help":
      ...
      break;
    case "game":
      loopLines(game, "color2 margin", 80)
      addLine("What a lovely game.", "color2", 80)
      break;
    case "skeleton":
      loopLines(skeleton, "color2 margin", 80);
      break;
    case "shantry":
      loopLines(shantry, "color2 margin", 80);
      break;
    case "whois":
